...
#define TPI_AVI_PIXEL_REP_TCLKSEL_HALF_CLKOUT	(0 << 6)
#define TPI_AVI_PIXEL_REP_TCLKSEL_1X_CLKOUT	(1 << 6)
#define TPI_AVI_PIXEL_REP_TCLKSEL_2X_CLKOUT	(2 << 6)
#define TPI_AVI_PIXEL_REP_TCLKSEL_4X_CLKOUT	(3 << 6)
